const disainSliderPagination5 = () => {
  const tabHeader = document.querySelector('#designs');
  const wrap = document.querySelector('.designs-slider__style5')
...
export default disainSliderPagination5;